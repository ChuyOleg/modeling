package ip91.chui.oleh.bank.service;
...
public class Model {
  ...
  private static final String QUEUE_1_NAME = "queue_1";
  private static final String QUEUE_2_NAME = "queue_2";
  private static final String SWAP_QUEUE_RESULT_MSG = "Clients have swapped queue %d times%n";
  private static final String CAR_SWAP_QUEUE = "The Car has moved from %s to %s %n";
