...
import ip91.chui.oleh.hospital.service.FunRand;
...
public class Element {
  ...
  protected static final String PATIENT_MOVE_FROM_TO = "The Patient <%s> has moved from <%s> to <%s>%n";
  ...
  private Distribution secDistribution;
